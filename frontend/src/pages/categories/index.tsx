...
import { ArrowUpDown, Plus, SquarePen, Tag, Trash, Utensils } from "lucide-react";
    ...
    <Page className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-3 gap-6">
        <Card className="p-6 flex flex-col gap-4 w-full">
          <CardHeader className="p-0">
            <CardTitle className="flex items-center gap-4">
              ...
              <h3 className="text-gray-800 text-[38px] leading-8 font-bold">8</h3>
            </CardTitle>
          </CardHeader>
        ...
        <Card className="p-6 flex flex-col gap-4 w-full">
          <CardHeader className="p-0">
            <CardTitle className="flex items-center gap-4">
              ...
              <h3 className="text-gray-800 text-[38px] leading-8 font-bold">27</h3>
            </CardTitle>
          </CardHeader>
          <CardContent className="p-0">
        ...
        <Card className="p-6 flex flex-col gap-4 w-full">
          <CardHeader className="p-0">
            <CardTitle className="flex items-center gap-4">
              <Utensils size={24} className="text-blue-base" />
              <h3 className="text-gray-800 text-[38px] leading-8 font-bold">Alimentação</h3>
            </CardTitle>
          </CardHeader>
          <CardContent className="p-0">
          ...
          <>
            {categories.map((category) => (
              <Card className="p-6" key={category.id}>
                <CardContent className="p-0 flex flex-col gap-5">
                  <div className="flex items-center justify-between">
                    <Badge className={`p-3 bg-${category.color}-light hover:bg-${category.color}`}>
                      <DynamicIcon name={category.icon} size={16} className={`text-${category.color}-base`} />
                    </Badge>
                    <div className="flex  items-center gap-2">
                  ...
                  <div className="flex items-center justify-between">
                    <Badge className={`bg-${category.color} text-${category.color} py-1 px-3 rounded-full`}>
                      {category.name}
                    </Badge>
                    <span className="text-gray-600 text-sm">12 itens</span>
                  </div>
                </CardContent>
              </Card>
            ))}
